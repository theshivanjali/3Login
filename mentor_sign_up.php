...
require 'mentor_signup_handler.php';
...
<body>
	<div class="container">
		<div class="row">
			...
			<form method="POST" action="mentor_sign_up.php">
				<input type="text" name="mentor_name" class="form-control" placeholder="Enter Name">
			
				<input type="email" name="mentor_email" class="form-control" placeholder="Enter Email">
				...
				<input type="email" name="mentor_email2" class="form-control" placeholder="Confirm Email">
                  <?php
						if (in_array( "Emails do not match", $error_array))
                                      echo "<p class=' text-bold text-center text-danger'>Emails do not match</p>";

                 ?>   
				<input type="password" name="mentor_password" class="form-control" placeholder="Password">
				...
				<input type="password" name="mentor_password2" class="form-control" placeholder="Confirm Password">
				...
				<input type="submit" Value="Register" class="btn btn-warning btn-block" name="mentor_register">
